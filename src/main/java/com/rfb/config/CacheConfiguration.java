...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            ...
            cm.createCache(com.rfb.domain.RfbLocation.class.getName() + ".rbfEvents", jcacheConfiguration);
            cm.createCache(com.rfb.domain.RfbEvent.class.getName(), jcacheConfiguration);
            cm.createCache(com.rfb.domain.RfbEvent.class.getName() + ".rbfEventAttendances", jcacheConfiguration);
